...
//        		en los paréntesis de abajo va lo que separe los términos
        	...
        	System.out.println("Salir al menu Principal -1 / Salir -0");
        	opcion=n.nextInt();
        	if(opcion==1) {
        		menuPrincipal();
        	}
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
	    public void registrarParada() {
	    	while(paradas[0]==null) {
	    		for(int pos=0;pos<paradas.length;pos++) {
	    			paradas[pos]="1";
	    		}
	    	}
	    	...
	    	do {
	    		...
	    		System.out.println(" ");
	    		while(nombre.length()<3) {
	    			System.out.print("Error, digitos insuficientes \nIngrese un nombre valido: ");
	    			nombre = t.nextLine();
	    		}
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
	    public void registrarConexion() {
	    	...
	    	System.out.println("Simplemente Registre las Conexiones ");
	    	System.out.println(" ");
	    	...
	    	do {
	    		...
	    		for(int pos=0;pos<paradas.length;pos++) {
	    			if(paradas[pos].equals("Codigo: "+pOrigen)) {
	    				conexion[conex]=pOrigen;
	    				conex++;
	    			}
	    			if(paradas[pos].equals("Codigo: "+pDestino)) {
	    				conexion[conex]=pDestino;
	    				conex++;
	    			}
	    		}
	    		...
	    		km = t.nextLine();
	    		while(km.length()<1) {
	    			System.out.print("Error, los KM no pueden ser igual a 0 \nIngrese una distancia valida: ");
	    			km = t.nextLine();
	    		}
	    		System.out.println(" ");
	    		conexion[conex] = km;
	    		...
	    		if(conexion!=null) {
	    			System.out.print("Parada Origen: " + conexion[conex-2] + "\nParada Destino: " + conexion[conex-1] + "\nDistancia (en km): " + conexion[conex]);
		    		System.out.println(" ");
		    		System.out.println("Conexion Registrada Exitosamente");
		    		conex++;
	    		}else {
	    			System.out.println("Error, existen datos nulos o vacios \nDebera ingresar todo nuevamente");
	    			registrarConexion();
